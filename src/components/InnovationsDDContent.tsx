...
const InnovationsDDContent = () => {
  return (
    <div className="absolute z-10 left-0 right-0 bg-red-200 border-gray-200 shadow-sm border-y dark:bg-gray-800 dark:border-gray-600">
            ...
            <ul aria-labelledby="mega-menu-full-dropdown-button">
                <li>
                    <Link href="#" className="block p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700">
                        <div className="font-semibold">Innovations - Online Stores</div>
...
export default InnovationsDDContent;